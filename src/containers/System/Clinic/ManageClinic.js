...
class ManageClinic extends Component {
  ...
  handleOnChangInput = (event, id) => {
    try {
      ...
      console.error("Error in handleOnChangInput:", error);
      // Handle error as per your application's requirements
    }
  };
  ...
  handleOnchangeImage = async (event) => {
    try {
      ...
      console.error("Error in handleOnchangeImage:", error);
      // Handle error as per your application's requirements
    }
  };
  ...
  handleSaveNewClinic = async () => {
    try {
      ...
      console.error("Error in handleSaveNewClinic:", error);
      // Handle error as per your application's requirements
    }
  };
  ...
  handleEditClinic = (clinic) => {
    try {
      ...
      console.error("Error in handleEditClinic:", error);
      // Handle error as per your application's requirements
    }
  };
